...
class TestingsControllerTest < ActionController::TestCase
  ...
  test "should create testing" do
    assert_difference('Testing.count') do
      post :create, testing: { firstname: @testing.firstname, lastname: @testing.lastname, user_id: @testing.user_id, username: @testing.username }
    end
  ...
  test "should update testing" do
    patch :update, id: @testing, testing: { firstname: @testing.firstname, lastname: @testing.lastname, user_id: @testing.user_id, username: @testing.username }
    assert_redirected_to testing_path(assigns(:testing))
  end
